...
const Sidebar = () => {
    return (
        ...
        >
            ...
            <Link
                width={{ base: 'auto', lg: "100%" }} mt={{base:0,md:'auto'}} mb={{base:0,md:2}}  rounded={'md'}  textAlign={'center'} fontSize={30} color={"white"}
            >
                <NavLink style={{borderRadius:7,padding:"10px", width: "100%", height: "100%", display: "flex", alignItems: "center" }} to={'/'}>
                    <FiHome />
                    <Text display={{ base: "none", lg: "block" }} fontSize={16} ml={2}>Home</Text>
                </NavLink>
            </Link>
            <Link
                width={{ base: 'auto', lg: "100%" }} my={{ base: 0, md: 2 }}  rounded={'md'}  textAlign={'center'} fontSize={30} color={"white"}
            >
                <NavLink style={{borderRadius:7,padding:"10px", width: "100%", height: "100%", display: "flex", alignItems: "center" }} to={'/search'}>
                    <FiSearch />
            ...
            <Link
                width={{ base: 'auto', lg: "100%" }} my={{ base: 0, md: 2 }}  rounded={'md'}  textAlign={'center'} fontSize={30} color={"white"}
            >
                <NavLink style={{borderRadius:7,padding:"10px", width: "100%", height: "100%", display: "flex", alignItems: "center" }} to={'/add'}>
                    <FiPlus />
                    <Text display={{ base: "none", lg: "block" }} ml={2} fontSize={16}>Create</Text>
                </NavLink>
            </Link>
            <Link
                width={{ base: 'auto', lg: "100%" }} mb={{ base: 0, md: 'auto' }}  rounded={'md'}  textAlign={'center'} fontSize={30} color={"white"}
            >
                <NavLink style={{borderRadius:7,padding:"10px", width: "100%", height: "100%", display: "flex", alignItems: "center" }} to={'/profile'}>
                    <FiUser />
